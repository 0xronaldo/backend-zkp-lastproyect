    ...
    return {
        ...
        "proof": {
            ...
            "issuerData": {
                "id": did,
                "state": {
                    "claimsTreeRoot": "0x" + crypto.randomBytes(32).toString('hex'),
                    "value": "0x" + crypto.randomBytes(32).toString('hex')
                },
                "authCoreClaim": "0x" + crypto.randomBytes(32).toString('hex'),
                "mtp": {
                    "existence": true,
                    "siblings": []
                }
            },
            "coreClaim": "0x" + crypto.randomBytes(64).toString('hex'),
            "signature": "0x" + crypto.randomBytes(64).toString('hex'),
            "note": "Credencial generada localmente. Firma simulada para desarrollo."
        }
    };
};
